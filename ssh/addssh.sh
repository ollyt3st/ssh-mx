...
udps="$(cat ~/log-install.txt | grep -w "udpserver" | cut -d: -f2)"
...
echo -e "=============================="
echo -e "GET wss://[host] HTTP/1.1[crlf]Host: bughost.com[crlf]Connection: Upgrade[crlf]User-Agent: [ua][crlf]Upgrade: websocket[crlf][crlf]"
echo -e "=============================="
