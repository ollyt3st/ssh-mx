...
ExecStart=/usr/local/bin/ohpserver -port 80 -proxy 127.0.0.1:3128 -tunnel 127.0.0.1:443
Restart=on-failure
...
AmbientCapabilities=CAP_NET_ADMIN CAP_NET_BIND_SERVICE
NoNewPrivileges=true
ExecStart=/usr/local/bin/ohpserver -port 8383 -proxy 127.0.0.1:3128 -tunnel 127.0.0.1:443
Restart=on-failure
LimitNOFILE=infinity
